...
const ShopCart = () => {
    ...
    return (
        <div className='flex justify-between items-start mt-[150px] mb-[480px] mx-44  transition-all duration-200 ease-in-out xl:mt-[120px] xl:mx-20 xl:mb-12 lg:flex-col-reverse lg:mt-[120px] lg:mx-20 lg:mb-12 lg:items-center md:mt-[120px] md:mx-10 md:mb-12 sm:mt-[120px] sm:mx-5 sm:mb-12'>
