           ...
           <form onSubmit={SubmitHandeler} className="border-[1px] border-solid border-silver w-fit p-12 m-12 rounded-[10px] h-fit bg-white sm:p-5 sm:my-12 sm:mx-5 sm:w-[90%] ">
            ...
            <div className="flex flex-col mb-2.5 h-[75px]">
                ...
                className={(errors.name && touched.name) ? styles.uncompleted : styles.formInput }
                 ...
                 />
                {errors.name && touched.name && <span className="h-2.5 text-left mt-1 w-fit text-xs text-[#ff0000] leading-[10px] p-1 rounded bg-[#ff00002d]">{errors.name}</span>}
            </div>
            <div className="flex flex-col mb-2.5 h-[75px]">
               ...
               onFocus={focusHandler}
               />
               {errors.email && touched.email &&<span className="h-2.5 text-left mt-1 w-fit text-xs text-[#ff0000] leading-[10px] p-1 rounded bg-[#ff00002d]">{errors.email}</span>}
            </div>
            <div className="flex flex-col mb-2.5 h-[75px]">
                ...
                onFocus={focusHandler}
                />
                {errors.password && touched.password && <span className="h-2.5 text-left mt-1 w-fit text-xs leading-[10px] text-[#ff0000] p-1 rounded bg-[#ff00002d]">{errors.password}</span>}
            </div>
            <div className="flex flex-col mb-2.5 h-[75px]">
                ...
                onChange={changeHandler} 
                onFocus={focusHandler}/>
                {errors.confirmPassword &&touched.confirmPassword && <span className="h-2.5 text-left mt-1 w-fit text-xs text-[#ff0000] leading-[10px]  p-1 rounded bg-[#ff00002d]">{errors.confirmPassword}</span>}
            </div>
            <div className="flex flex-col mb-2.5 h-[75px]">
