...
const ShopCart = () => {
    ...
    return (
        <div className='flex justify-between items-start mt-[150px] mb-[480px] mx-44 min-h-min transition-all duration-200 ease-in-out xl:mt-[120px] xl:mx-20 xl:mb-12 lg:flex-col-reverse lg:mt-[120px] lg:mx-20 lg:mb-12 lg:items-center md:mt-[120px] md:mx-10 md:mb-12 sm:mt-[120px] sm:mx-5 sm:mb-12'>
...

            {
                state.itemsCounter > 0 && <div className='w-[27%] bg-white border-[1px] border-solid border-silver rounded text-left lg:w-full mb-5'>
                    ...
                    <div className='flex justify-between items-baseline mt-[50px] mx-5 mb-2.5'>
                        <button className='checkout inline-block bg-light-green py-2 px-4 text-white font-bold border-noun rounded-md mb-5 transition-all duration-200 ease-in-out cursor-pointer hover:bg-[#167d32]' onClick={() => dispatch({type: "CHECKOUT"})}>Check Out</button>
                        <button className='cursor-pointer text-light-green bg-none border-none transition-all duration-200 ease-in-out text-base hover:text-[#167d32] ' onClick={() => dispatch({type: "CLEAR"})}>Clear</button>
                    </div>
                </div>
            }
